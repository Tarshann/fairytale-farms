...
import { ShoppingCart, Sparkles, Zap, Heart, Star, Snowflake } from "lucide-react";
...
export default function BickeringBros() {
  ...
  const freezeDriedCategory = categories?.find(c => c.slug === 'freeze-dried-candy');
      ...
      <main className="flex-1">
          ...
          <div className="container relative z-10">
            <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-6 max-w-2xl">
                Freeze-dried candy that's out of this world! Crunchy, airy, and bursting with flavor.
              </p>
              ...
              <p className="text-gray-400 text-sm italic">
                Made with love by two brothers using our Harvest Right Freeze Dryer
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-gray-300 text-lg mb-8 leading-relaxed">
                Freeze-drying removes all the moisture from candy, transforming it into a light, 
                crunchy, melt-in-your-mouth treat. The flavors become more intense and the texture 
                is unlike anything you've ever tried! It's the same candy you love, but with a 
              ...
              <div className="grid md:grid-cols-3 gap-6 mt-12">
                <Card className="bg-gray-900/50 border-yellow-500/30 text-white">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-gray-400 text-sm">
                      Light and airy with an amazing crunch that melts in your mouth
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-gray-900/50 border-red-500/30 text-white">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-gray-400 text-sm">
                      Concentrated taste that's even more flavorful than the original
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-gray-900/50 border-blue-500/30 text-white">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-gray-400 text-sm">
                      Shelf-stable for months - if you can resist eating them all!
                    </p>
                  </CardContent>
                </Card>
              </div>
        ...
        <section className="py-16 bg-gray-900">
          <div className="container">
            ...
            {isLoading ? (
              <div className="text-center text-gray-400">Loading delicious treats...</div>
            ) : products && products.length > 0 ? (
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {products.map((product) => (
                  <Card key={product.id} className="bg-gray-800 border-gray-700 overflow-hidden group hover:border-yellow-500/50 transition-all">
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-400 max-w-md mx-auto">
                  The Bickering Bros are hard at work creating amazing freeze-dried treats. 
                  Check back soon for our first batch of crunchy goodness!
                </p>
              </div>
            )}
          </div>
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-gray-300 text-lg mb-8">
                Two brothers with a passion for candy and a dream to share the most amazing 
                freeze-dried treats with the world. Sure, we might bicker about which candy 
                to make next, but we always agree on one thing: it has to be delicious!
              </p>
