  ...
  return (
    <div className="flex items-center gap-2">
      <span className={`relative flex h-3 w-3`}>
        <span
          className={`animate-ping absolute inline-flex h-full w-full rounded-full opacity-75 ${isLive ? "bg-green-400" : "bg-gray-400"}`}
        ></span>
        <span
          className={`relative inline-flex rounded-full h-3 w-3 ${isLive ? "bg-green-500" : "bg-gray-500"}`}
        ></span>
      </span>
      <span
      ...
      <CardContent className="p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <Badge
              className={`mt-2 text-xs ${statusColors[build.status as keyof typeof statusColors]}`}
            >
          ...
          <div className="container relative">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8">
                Catch today's tools being made for tomorrow's cookies. Watch
                custom cutters, stamps, and embossers come to life!
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                From custom design to delicious decorated cookies — watch the
                journey unfold
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="bg-gradient-to-br from-pastel-peach/30 to-white border-pastel-peach/50">
                <CardContent className="p-6 text-center">
                  ...
                  <h4 className="font-semibold text-sm uppercase tracking-wide text-orange-700 mb-2">
                    Now Printing
                  </h4>
                  <p className="text-foreground font-medium">
                    Cowboy Theme Cutter Set
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-pastel-lavender/30 to-white border-pastel-lavender/50">
                <CardContent className="p-6 text-center">
                  <span className="text-3xl mb-3 block">⏭️</span>
                  <h4 className="font-semibold text-sm uppercase tracking-wide text-purple-700 mb-2">
                    Next Up
                  </h4>
                  <p className="text-foreground font-medium">
                    Birthday Balloon Embosser
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-pastel-mint/30 to-white border-pastel-mint/50">
                <CardContent className="p-6 text-center">
                  ...
                  <h4 className="font-semibold text-sm uppercase tracking-wide text-green-700 mb-2">
                    Bake Pairing
                  </h4>
                  <p className="text-foreground font-medium">
                    Vanilla bean + raspberry royal icing
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="container">
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                We can create custom cutters, stamps, and embossers for your
                special occasion. Your design, your cookies, your story!
              </p>
