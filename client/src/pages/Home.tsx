...
export default function Home() {
  ...
  const cookiesImage =
    "/images/gallery/sugar-cookies-wedding-kelsea-tommy.jpeg";
          ...
          <div className="container relative z-10 py-16 md:py-24">
            <div className="max-w-2xl space-y-6">
              ...
              <p className="text-lg md:text-xl text-gray-700">
                Handcrafted desserts for birthdays, celebrations, and everyday
                moments—made fresh, never mass-produced.
              </p>
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <Link href="/contact">
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-2 border-gray-800 text-gray-800 hover:bg-gray-100"
                  >
          ...
          <div className="container">
            ...
            <div className="max-w-3xl mx-auto text-center space-y-6">
              ...
              <p className="text-sm text-gray-500">
                Starting at $75 for a 6-inch cake
              </p>

              <p className="text-lg text-gray-700">
                From kids' birthdays to milestone celebrations, every cake is
                designed specifically for your event.
              </p>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm mt-8">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center">
                    <div className="w-12 h-12 rounded-full bg-pink-100 text-pink-600 font-bold text-xl flex items-center justify-center mx-auto mb-3">
                      1
                    </div>
                    <p className="text-gray-700">
                      Tell us your idea using our cake inquiry form
                    </p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 rounded-full bg-pink-100 text-pink-600 font-bold text-xl flex items-center justify-center mx-auto mb-3">
                    ...
                    <p className="text-gray-700">
                      We confirm design, size, and pricing
                    </p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 rounded-full bg-pink-100 text-pink-600 font-bold text-xl flex items-center justify-center mx-auto mb-3">
                    ...
                    <p className="text-gray-700">
                      Your cake is baked fresh and ready for pickup
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="container">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-600">
                Every dessert is made with care and attention to detail.
              </p>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                <h2 className="text-3xl md:text-4xl font-bold">
                  Welcome to Fairytale Farms
                </h2>

                <p className="text-lg text-gray-700 leading-relaxed">
                  Fairytale Farms is a small, family-run bakery built on love
                  for baking and celebrating life's sweetest moments. Every
                  order is handcrafted, thoughtfully designed, and made as if it
                  were for our own family.
                </p>

                <p className="text-lg text-gray-700 leading-relaxed">
                  We believe desserts should feel special—because the moments
                  they're part of truly are.
                </p>
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="space-y-4">
                  <div className="w-16 h-16 rounded-full bg-pink-100 text-pink-600 font-bold text-2xl flex items-center justify-center mx-auto">
                    1
                  </div>
                  <h3 className="font-semibold text-lg">Choose</h3>
                  <p className="text-gray-600">
                    Choose a ready-to-order item or submit a custom request
                  </p>
                </div>
                <div className="space-y-4">
                  <div className="w-16 h-16 rounded-full bg-pink-100 text-pink-600 font-bold text-2xl flex items-center justify-center mx-auto">
