          ...
          <div className="container relative z-10">
            <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Where every treat tells a story, and every bite creates a
                memory.
              </p>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    Fairytale Farms began in a small kitchen with a big dream:
                    to create treats that bring joy and wonder to every
                    celebration. What started as baking for family and friends
                    quickly blossomed into something magical.
                  </p>
                  <p>
                    Based in Castalian Springs, Tennessee, we believe that every
                    cookie, cake, and sweet treat should be crafted with the
                    same love and attention you'd give to something made for
                    your own family. Because to us, every customer becomes part
                    of our Fairytale Farms family.
                  </p>
                </div>
              </div>
          ...
          <div className="container">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                From custom celebration cakes to artisanal sugar cookies, each
                creation is made fresh to order with premium ingredients and
                endless creativity.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  title: "Custom Cakes",
                  description:
                    "Stunning celebration cakes designed for your special moments, from birthdays to weddings.",
                ...
                },
                {
                  ...
                  title: "Sugar Cookies",
                  description:
                    "Beautifully decorated cookies featuring custom designs, including our signature 3D-printed cutters.",
                ...
                },
                {
                  ...
                  title: "Sweet Treats",
                  description:
                    "Cinnamon buns, cake pops, brownies, cheesecakes, and chocolate covered strawberries.",
                ...
                },
                {
                  ...
                  description:
                    "Special limited-edition treats for holidays and celebrations throughout the year.",
                ...
                },
                {
                  ...
                  description:
                    "Unique designs brought to life with our innovative cookie cutter lab and artistic decorating.",
                ...
                },
                {
                  ...
                  description:
                    "Only the finest ingredients, made fresh to order with attention to every detail.",
                  color: "text-gold",
                },
              ].map((item, index) => (
                <Card
                ...
                >
                  <CardContent className="p-6 text-center">
                    <item.icon
                      className={`h-10 w-10 mx-auto mb-4 ${item.color}`}
                    />
          ...
          <div className="container">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Step behind the scenes and discover how we bring custom cookie
                designs to life. Our lab combines creativity with innovation to
                create one-of-a-kind cookie cutters for truly unique treats.
              </p>
              <Link href="/lab">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Every treat is handcrafted with care and attention, just like
                  we'd make for our own family.
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Proudly serving Sumner County with DoorDash & Uber Eats
                  delivery and a commitment to our neighbors.
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  From custom designs to innovative techniques, we bring your
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-6">
                  ...
                  <h2 className="text-3xl font-bold">Serving Sumner County</h2>
                  <p className="text-muted-foreground">
                    Based in Castalian Springs, Tennessee, we deliver fresh
                    treats throughout Sumner County via DoorDash & Uber Eats.
                    Can't wait? Local pickup is always available!
                  </p>
                  <div className="flex flex-wrap gap-3">
                    <Link href="/delivery-zones">
                      <Button variant="outline">Check Delivery Area</Button>
                    </Link>
                    <Link href="/contact">
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Whether it's a birthday celebration, wedding, holiday gathering,
                or just because – let us help make your moment unforgettable.
              </p>
