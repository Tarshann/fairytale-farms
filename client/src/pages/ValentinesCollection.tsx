          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-10">
              ...
              <div className="flex items-center gap-2 bg-white/80 rounded-full px-4 py-2 shadow-sm">
                ...
                <span className="text-sm font-medium">30-Mile Delivery Radius</span>
              </div>
              <div className="flex items-center gap-2 bg-white/80 rounded-full px-4 py-2 shadow-sm">
      ...
      <section className="py-16 bg-muted/30">
        <div className="container">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Serving the Greater Nashville area with love</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Card className="text-center p-6">
              ...
              <p className="text-sm text-muted-foreground">
                From Goodlettsville, TN. Nashville, Franklin, Murfreesboro, and surrounding areas.
              </p>
            </Card>
