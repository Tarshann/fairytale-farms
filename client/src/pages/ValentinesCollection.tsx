...
export default function ValentinesCollection() {
  ...
  const { data: tiers, isLoading: tiersLoading } =
    trpc.valentines.tiers.useQuery();
        ...
        <div className="container relative py-20 md:py-32">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button
                size="lg"
                className="bg-primary hover:bg-primary/90 text-white shadow-pastel"
              >
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Valentine's Dessert Boxes
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Three perfectly crafted collections, each handmade with love.
          ...
          {tiersLoading ? (
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {tiers?.map((tier, index) => {
                ...
                const remaining = tier.inventoryCap
                  ? tier.inventoryCap - (tier.inventorySold || 0)
                  : null;
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`absolute top-4 right-4 z-10`}>
                      <Badge
                        className={`${colors.bg} ${colors.accent} border-0`}
                      >
                        Tier {index + 1}
                      </Badge>
                    </div>
                    ...
                    >
                      ...
                      <Gift
                        className={`w-20 h-20 ${colors.accent} opacity-50`}
                      />
                    </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  Turn your favorite photo into an edible keepsake. Our artists
                  lovingly transform your memories into hand-crafted Oreo
                  masterpieces that taste as magical as they look.
                </p>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Anniversary photos, family portraits, pet tributes,
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Order cutoff: February 10, 2026. 50% deposit required at
                        booking.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Only 10 custom portrait orders accepted. 6-puck minimum
                        ($48).
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-muted-foreground">
                        Your photo, transformed into edible art
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">
                Looking to add a little extra sweetness? Chocolate-covered
                strawberries are the only add-on available for Valentine's Day
                and{" "}
                <span className="font-semibold text-pink-600">
                  must be purchased with a Valentine's box
                </span>
                .
              </p>
            </div>
              ...
              <div className="bg-gradient-to-r from-pink-100 to-red-100 p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Hand-dipped in milk or white chocolate with
                      Valentine's-themed details
                    </p>
                  </div>
                </div>
              </div>
              ...
              <CardContent className="p-6">
                <div className="grid md:grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="bg-white border border-pink-100 rounded-lg p-4 text-center hover:shadow-md transition-shadow relative">
                    <Badge className="absolute -top-2 -right-2 bg-pink-500 text-white border-0">
                      Best Value
                    </Badge>
                    <div className="text-3xl font-bold text-primary mb-1">
                      $35
                ...
                <div className="bg-pink-50 rounded-lg p-4">
                  <p className="text-sm text-pink-800">
                    <span className="font-semibold">Note:</span> Flavors can be
                    mix-and-matched between milk and white chocolate. Add-ons
                    will be included with your Valentine's box order.
                  </p>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Serving Sumner County with love
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Card className="text-center p-6">
              ...
              <p className="text-sm text-muted-foreground">
                From Castalian Springs, TN via DoorDash & Uber Eats throughout
                Sumner County.
              </p>
            </Card>
            ...
            <Card className="text-center p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Choose your preferred delivery date. Same-day and scheduled
                options available.
              </p>
            </Card>
