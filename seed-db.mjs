...
const productsData = [
  // Customized Cakes (pricing from pricing-reference-final.md)
  {
    ...
    customizationInstructions:
      'Please specify: cake size (6", 8", 10"), flavor (vanilla, chocolate, red velvet, etc.), frosting type, color scheme, and any special decorations or messages you\'d like.',
    inStock: true,
    featured: true,
    displayOrder: 1,
  },
  {
    ...
    isCustomizable: true,
    customizationInstructions:
      "Please specify: number of tiers, serving size, flavors for each tier, frosting style, color palette, and decoration preferences. We recommend scheduling a consultation for wedding cakes.",
    inStock: true,
    featured: true,
    displayOrder: 2,
  },
  {
    ...
    isCustomizable: true,
    customizationInstructions:
      "Please describe your theme, preferred colors, size needed, flavor preferences, and any specific design elements you'd like incorporated.",
    inStock: true,
    featured: false,
    displayOrder: 3,
  },
  ...
  // Customized Sugar Cookies
  {
    ...
    description:
      "One dozen beautifully decorated sugar cookies. Perfect for parties, gifts, or special occasions. Each cookie is hand-decorated with royal icing.",
    basePrice: "36.00",
    imageUrl: "/images/498671317_1317568696889150_4793173008111768826_n.jpg",
    isCustomizable: true,
    customizationInstructions:
      "Please specify: theme/design, color scheme, and any text or special details. Minimum order: 1 dozen.",
    inStock: true,
    featured: true,
    displayOrder: 1,
  },
  {
    ...
    isCustomizable: true,
    customizationInstructions:
      "Please describe desired shapes, colors, and design details. Custom cookie cutters may incur additional fees.",
    inStock: true,
    featured: false,
    displayOrder: 2,
  },
  ...
  // Cinnamon Buns
  {
    ...
    description:
      "Six warm, gooey cinnamon buns topped with cream cheese frosting. Made fresh daily with our signature recipe.",
    basePrice: "18.00",
  ...
  },
  {
    ...
    description:
      "One dozen of our famous cinnamon buns with cream cheese frosting. Perfect for sharing or freezing for later.",
    basePrice: "32.00",
    imageUrl: "/images/cinnamon_buns.jpg",
    isCustomizable: false,
    inStock: true,
  ...
  // Cake Pops
  {
    ...
    description:
      "One dozen cake pops in your choice of flavors and decorations. These bite-sized treats are perfect for parties and gifts.",
    basePrice: "24.00",
    imageUrl: "/images/cake_pops.jpg",
    isCustomizable: true,
    customizationInstructions:
      "Please specify: cake flavor (vanilla, chocolate, red velvet), coating color, and any decorative elements (sprinkles, drizzle, themed decorations).",
    inStock: true,
    featured: false,
    displayOrder: 1,
  },
  ...
  // Brownies
  {
    ...
    description:
      "Six rich, fudgy brownies made with premium chocolate. Dense, moist, and absolutely delicious.",
    basePrice: "15.00",
  ...
  // Cheesecake
  {
    ...
    description:
      "Rich and creamy New York style cheesecake with graham cracker crust. Serves 8-10.",
    basePrice: "45.00",
  ...
  },
  {
    ...
    description:
      "Creamy cheesecake in your choice of flavor: strawberry, chocolate, caramel, or seasonal special. Serves 8-10.",
    basePrice: "48.00",
    imageUrl: "/images/cheesecake.jpg",
    isCustomizable: true,
    customizationInstructions:
      "Please specify your preferred flavor: strawberry, chocolate, caramel, or ask about seasonal options.",
    inStock: true,
    featured: false,
    displayOrder: 2,
  },
  ...
  // Chocolate Covered Strawberries
  {
    ...
    description:
      "Six fresh strawberries hand-dipped in premium chocolate. Simple, elegant, and delicious.",
    basePrice: "18.00",
  ...
  },
  {
    ...
    isCustomizable: true,
    customizationInstructions:
      "Specify if you'd like decorative drizzle, sprinkles, or themed decorations.",
    inStock: true,
    featured: true,
    displayOrder: 2,
  },
